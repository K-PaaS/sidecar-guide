...
## <div id='1.2'> 1.2. 범위
본 문서는 [korifi v0.12.0](https://github.com/cloudfoundry/korifi/tree/v0.12.0), [sidecar-deployment v2.0.0](https://github.com/K-PaaS/sidecar-deployment/tree/v2.0.0)를 기준으로 작성하였다.  
